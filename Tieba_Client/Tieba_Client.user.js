...
// @author 网络中二行客
// @version 1.0.2
// @description 模拟贴吧客户端发帖。
// @updateURL https://userscript.firefoxcn.net/js/Tieba_Client.meta.js
// @downloadURL https://userscript.firefoxcn.net/js/Tieba_Client.user.js
// ==/UserScript==
;(function($,UW){
    const
        BDUSS = "",
