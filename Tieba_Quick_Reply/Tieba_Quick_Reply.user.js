// ==UserScript==
// @name Tieba Quick Reply
// @namespace http://tieba.baidu.com
// @include http://tieba.baidu.com/f?*
// @grant none
// @version 0.4
// @author 网络中二行客
// @description 贴吧列表页快速回复。
// @updateURL https://userscript.firefoxcn.net/js/Tieba_Quick_Reply.meta.js
// @downloadURL https://userscript.firefoxcn.net/js/Tieba_Quick_Reply.user.js
// ==/UserScript==
;(function($,PageData){
    const
